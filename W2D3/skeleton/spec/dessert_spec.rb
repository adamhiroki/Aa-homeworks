...
describe Dessert do
  let(:chef) { double("chef", name: "Badi") }
  ...
  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do
      brownie.add_ingredient("mousse")
      expect(brownie.ingredients).to include("mousse")
    end
  end

  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ["chocolate", "mousse", "egg"]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Badu")
      expect(brownie.serve).to eq("Chef Badu has made 50 brownies!")
  end
end
